...
export function Friends({ className }: IconProps) {
  return (
    <Svg className={className}>
...
export function Gear({ className }: IconProps) {
  return (
    <Svg className={className}>
      ...
      <path d="M19.1 14.8a1.7 1.7 0 0 0 .34 1.87l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.7 1.7 0 0 0-1.87-.34 1.7 1.7 0 0 0-1.03 1.55v.17a2 2 0 1 1-4 0v-.09a1.7 1.7 0 0 0-1.11-1.55 1.7 1.7 0 0 0-1.87.34l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.7 1.7 0 0 0 .34-1.87 1.7 1.7 0 0 0-1.55-1.03H2.5a2 2 0 1 1 0-4h.09A1.7 1.7 0 0 0 4.14 8.8a1.7 1.7 0 0 0-.34-1.87l-.06-.06A2 2 0 1 1 6.57 4.04l.06.06a1.7 1.7 0 0 0 1.87.34h.08A1.7 1.7 0 0 0 9.6 2.89V2.7a2 2 0 1 1 4 0v.09a1.7 1.7 0 0 0 1.03 1.55 1.7 1.7 0 0 0 1.87-.34l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.34 1.87v.08a1.7 1.7 0 0 0 1.55 1.03h.17a2 2 0 1 1 0 4h-.09a1.7 1.7 0 0 0-1.52 1.02z" />
    </Svg>
  );
}
...
export function Settings({ className }: IconProps) {
  return (
    <Svg className={className}>
      <path d="M3 18V7a2 2 0 0 1 2-2h4l2 2.5h6a2 2 0 0 1 2 2v1.5" />
      <path d="M3 18l2.2-6.2a1 1 0 0 1 .95-.8H21l-2.2 6.2a1 1 0 0 1-.95.8z" />
    </Svg>
  );
}
